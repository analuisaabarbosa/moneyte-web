...
const AuthForm = ({ formType, handleSubmit, loading, error }) => {
  ...
  const title = isRegister ? "Crie sua conta" : "Bem-vindo de volta";
  const subTitle = isRegister
    ? "Comece a organizar suas finanças"
    : "Acesse sua conta moneyte";
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              id="password"
              className="w-full rounded-xl border border-white/20 bg-white/20 pr-10 pl-4 py-3 text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none"
